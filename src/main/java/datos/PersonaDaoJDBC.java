...
public  class PersonaDaoJDBC implements PersonaDao {//es persona JDBC
    ...
    public List<PersonaDTO> seleccionar() throws SQLException {
        ...
        PersonaDTO persona = null;/*Creamos un objeto de tipo PersonaDTO */
        List<PersonaDTO> personas = new ArrayList<>();/*creamos una lista de personas parair guardando todas las personas*/
        try {
