...
public class UsuarioDaoJDBC implements UsuarioDao {
    ...
    public List<UsuarioDTO> listar() throws SQLException {
        ...
        UsuarioDTO usuario = null;/*creamos un objeto de tipo usuario */
        List<UsuarioDTO> usuarios = new ArrayList<>();/*creamos una lista de usuarios parair guardando todos lo usuarios*/
        try {
            ...
            while (rs.next()) {
                ...
                usuario = new UsuarioDTO(idUsuario, uzuario, contrasenia);/*sacamos los datos de la bdd y lo convertimos en un objeto*/
